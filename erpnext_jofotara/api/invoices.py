...
def generate_ubl_xml(doc) -> str:
    ...
    parts += [
        ...
        f'  <cbc:InvoiceTypeCode listID="UNCL1001" listAgencyID="6" listAgencyName="United Nations Economic Commission for Europe" listVersionID="D16B">{inv_code}</cbc:InvoiceTypeCode>',
